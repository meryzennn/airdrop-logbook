...
export default async function DashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-zinc-50 dark:bg-zinc-950 p-4 md:p-12 font-sans overflow-hidden relative">
      ...
      <div className="max-w-6xl mx-auto space-y-6 md:space-y-8 relative z-10">
        <header className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6 p-5 sm:p-6 rounded-3xl backdrop-blur-xl bg-white/40 dark:bg-zinc-900/40 border border-white/40 dark:border-zinc-800 shadow-xl">
          ...
          <div className="flex items-center gap-3 sm:gap-4 flex-wrap justify-center">
            {session.user?.image && (
              <img
                ...
                alt="Avatar"
                className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.4)] transition-transform hover:scale-110"
